...
function Command({ className, ...props }: React.ComponentProps<typeof CommandPrimitive>) {
    return (
        <CommandPrimitive
            data-slot="command"
            className={cn('bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-xs', className)}
            {...props}
        />
    )
}
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
    return (
        <CommandPrimitive.List
            ...
            className={cn('max-h-[300px] scroll-py-1 overflow-x-hidden overflow-y-auto no-scrollbar', className)}
            {...props}
        />
    )
}
