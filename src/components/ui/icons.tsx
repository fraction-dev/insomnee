...
const SVGIcon: FC<SVGIconProps> = ({
    ...
    return (
        <svg
            width={size}
            height={size}
            viewBox={`0 0 ${intrinsicContentDimension} ${intrinsicContentDimension}`}
            fill={fill}
            stroke={stroke}
...
export const Icons = {
    ...
    Decimals: ({ className, size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) => (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            height={size}
            viewBox="0 -960 960 960"
    ...
    Outlook: (props: any) => (
        <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 48 48" {...props}>
            <path fill="#1a237e" d="m43.607 23.752-7.162-4.172v11.594H44v-6.738a.793.793 0 0 0-.393-.684z" />
            <path
                fill="#0c4999"
                d="M33.919 8.84h9.046V7.732c0-.957-.775-1.732-1.731-1.732H17.667c-.956 0-1.732.775-1.732 1.732V8.84h17.984z"
            />
            <path fill="#0f73d9" d="M33.919 33.522h7.314c.956 0 1.732-.775 1.732-1.732v-6.827h-9.046v8.559z" />
            <path fill="#0f439d" d="M15.936 24.964v6.827c0 .956.775 1.732 1.732 1.732h7.273v-8.558h-9.005z" />
    ...
    Delete: ({ size = 24, ...props }: { size?: number } & SVGProps<SVGSVGElement>) => (
